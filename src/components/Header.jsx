        ...
        <header>
            ...
            <div className="center">
                <NavLink className={activeClass} to="/home">
                    <i className="fa-solid fa-shop"></i>Inicio
                </NavLink>
                <NavLink className={activeClass} to="/products">
                    <i className="fa-solid fa-gift"></i>Productos
                </NavLink>
            ...
            {state?.logged ? (
                ...
                <>
                    <NavLink className={activeClass} to="/login">
                        <div className='right-center boton '>
                            <i className="fa-solid fa-right-to-bracket m-2"></i><h1>Iniciar Sesión</h1>
                        </div>
                    </NavLink>
                    <NavLink className={activeClass} to="/register">
                        <div className='right-right boton'>
                            <i className="fa-solid fa-address-card m-1"></i><h1>Registro Usuario</h1>
                        </div>
                    </NavLink>
                </>
